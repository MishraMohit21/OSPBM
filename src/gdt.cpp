...
GlobalDiscriptorTable::SegmentDiscriptor::SegmentDiscriptor(uint32_t base, uint32_t limit, uint8_t flags)
{
...
uint32_t GlobalDiscriptorTable::SegmentDiscriptor::Base()
{
    uint8_t* target = (uint8_t*)this;
...
uint32_t GlobalDiscriptorTable::SegmentDiscriptor::Limit()
{
    uint8_t* target = (uint8_t*)this;
